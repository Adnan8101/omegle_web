  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-fade-in">
      ...
      <div className="relative glass-blue rounded-3xl border border-[rgb(var(--color-border))]/60 dark:border-white/10 shadow-apple-2xl p-8 max-w-sm w-full text-center animate-scale-in">
        ...
        {won ? (
          <>
            <h2 className="text-2xl font-extrabold text-[rgb(var(--color-text-primary))] mb-1">
              Congratulations!
            </h2>
            ...
            <div className="text-base font-semibold text-[rgb(var(--color-text-primary))] mb-6 flex items-center justify-center gap-1">
              {renderEmoji(currencyEmoji)} {currencyName}
            </div>
          </>
        ) : (
          <>
            <h2 className="text-2xl font-extrabold text-[rgb(var(--color-text-primary))] mb-2">
              So close!
            </h2>
            <p className="text-sm text-[rgb(var(--color-text-secondary))] mb-6">
              No reward this time — try again for the big win.
            </p>
          </>
        )}
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="rounded-2xl bg-[rgb(var(--color-bg-tertiary))] p-3">
            ...
            <p className="text-lg font-bold text-[rgb(var(--color-text-primary))]">{newBalance.toLocaleString()}</p>
          </div>
          <div className="rounded-2xl bg-[rgb(var(--color-bg-tertiary))] p-3">
            <p className="text-[10px] uppercase tracking-wider text-[rgb(var(--color-text-tertiary))]">Spins Left</p>
            <p className="text-lg font-bold text-[rgb(var(--color-text-primary))]">{chancesLeft}</p>
          </div>
        </div>
