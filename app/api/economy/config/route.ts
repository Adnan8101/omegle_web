  ...
  try {
    ...
    const config = await prismaBot.economyConfig.upsert({
      ...
      create: {
        ...
        msg_ozy_amount: msg_ozy_amount ?? 1,
        min_message_length: min_message_length ?? 5,
        message_cooldown: message_cooldown ?? 5,
        daily_message_cap: daily_message_cap ?? 100,
        minutes_per_point: minutes_per_point ?? 5,
        vc_ozy_amount: vc_ozy_amount ?? 1,
        daily_voice_cap: daily_voice_cap ?? 100,
      ...
      update: {
        ...
        ...(msg_ozy_amount !== undefined && { msg_ozy_amount }),
        ...(min_message_length !== undefined && { min_message_length }),
        ...(message_cooldown !== undefined && { message_cooldown }),
        ...(daily_message_cap !== undefined && { daily_message_cap }),
        ...(minutes_per_point !== undefined && { minutes_per_point }),
        ...(vc_ozy_amount !== undefined && { vc_ozy_amount }),
        ...(daily_voice_cap !== undefined && { daily_voice_cap }),
