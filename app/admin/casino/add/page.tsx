...
import { FiArrowLeft, FiPlus, FiImage, FiX, FiLoader, FiCheck } from 'react-icons/fi';
...
export default function AddShopItem() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to the edit page after 1.5 seconds
      setTimeout(() => {
        router.push(`/admin/casino/edit/${data.item.id}`);
      }, 1500);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-[rgb(var(--color-text-tertiary))] animate-pulse">Loading...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[rgb(var(--color-text-primary))]">Create New Shop Item</h1>
            <p className="text-sm text-[rgb(var(--color-text-secondary))]">
              Add a new item to the casino shop
            </p>
          </div>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-xl text-green-500 flex items-center gap-2">
            <FiCheck className="w-5 h-5" />
            Item created successfully! Redirecting to edit page...
          </div>
        )}
              ...
              <div className="glass-blue p-6 rounded-2xl border border-[rgb(var(--color-border))]">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {formData.thumbnail && (
                      <div className="mt-3 p-3 bg-[rgb(var(--color-bg-tertiary))] rounded-xl border border-[rgb(var(--color-border))]">
                        <p className="text-xs text-[rgb(var(--color-text-tertiary))] mb-2">Preview</p>
                        <div className="w-32 h-32 rounded-lg overflow-hidden bg-[rgb(var(--color-bg-primary))]">
                          <img 
                          ...
                          />
                          <div className="w-full h-full items-center justify-center text-[rgb(var(--color-text-tertiary))] hidden">
