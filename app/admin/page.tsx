          ...
          <div className="space-y-6">
            ...
            {status === 'authenticated' && !session?.user?.permissions?.hasAnyAccess && (
              <div className="bg-red-500/10 border border-red-500/50 rounded-xl p-4 space-y-3">
                ...
                <button
                  onClick={() => router.push('/')}
                  className="w-full mt-4 px-4 py-2 bg-[rgb(var(--color-bg-secondary))] hover:bg-[rgb(var(--color-hover))] text-[rgb(var(--color-text-primary))] rounded-lg transition-colors"
                >
                  Go Back
                </button>
              </div>
