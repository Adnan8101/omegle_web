...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[rgb(var(--color-bg-primary))] apple-transition relative overflow-hidden">
      {/* Enhanced Animated Blue Background */}
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-8 z-50">
        ...
        >
          {theme === 'dark' ? (
            <FiSun className="w-5 h-5 sm:w-6 sm:h-6 text-blue-400" />
          ) : (
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        <div className="max-w-6xl w-full text-center space-y-8 sm:space-y-10 md:space-y-12 animate-fade-in">
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 dark:from-blue-400 dark:via-blue-300 dark:to-blue-400 animate-slide-up will-change-transform">
              Omeglee
            </h1>
            <div className="space-y-2">
              <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-blue-600 dark:text-blue-400 tracking-tight animate-slide-up will-change-transform" style={{ animationDelay: '0.1s' }}>
                Community
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto animate-scale-in will-change-transform" style={{ animationDelay: '0.2s' }}>
            <div className="glass-blue rounded-2xl p-6 border border-blue-500/20 hover:shadow-blue-glow apple-transition backdrop-blur-xl group will-change-transform">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-blue-500/10 rounded-2xl group-hover:scale-110 apple-transition will-change-transform">
          ...
          {/* Coming Soon Card */}
          <div className="glass-blue rounded-3xl p-8 sm:p-10 md:p-12 lg:p-16 border border-blue-500/30 shadow-blue-glow animate-scale-in backdrop-blur-xl hover:border-blue-500/50 apple-transition will-change-transform" style={{ animationDelay: '0.3s' }}>
            <div className="space-y-6 sm:space-y-7 md:space-y-8">
              <div className="inline-flex items-center justify-center px-6 py-2 bg-blue-500/20 rounded-full border border-blue-500/30 mb-4">
                <span className="text-blue-600 dark:text-blue-400 font-semibold text-sm">Coming Soon</span>
              </div>
          ...
          <div className="text-[rgb(var(--color-text-tertiary))] text-sm font-light animate-fade-in space-y-3 pt-8" style={{ animationDelay: '0.4s' }}>
            ...
            <a href="https://discord.gg/omegle" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-blue-600 dark:hover:text-blue-400 apple-transition text-base">
