...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[rgb(var(--color-bg-primary))] apple-transition relative overflow-hidden">
      {/* Background Video - Always visible with theme-based opacity */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[rgb(var(--color-bg-primary))] via-transparent to-[rgb(var(--color-bg-primary))] opacity-60"></div>
      </div>
